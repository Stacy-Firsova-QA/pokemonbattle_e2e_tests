...
class PremiumBuyFormLocators:
    main_form = (By.CSS_SELECTOR,
                 ".k_page_main_premium > div.profile-mobile-wrapper")
    profile_title = (By.XPATH,
                     "//div[contains(@class, 'k_page_main_premium')]/div[@class='profile-mobile-wrapper']/h1")
...
class PaymentCardFormLocators:
    ...
    error_number_input_text = (By.XPATH,
                               "//span[text()='Неверный номер карты']")
...
class PremiumSuccessLocators:
    title_premium = (By.XPATH,
                     "//div[@class='k_title_premium' and text()='Премиум успешно подключен!']")
