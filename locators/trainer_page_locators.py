...
class TrainerPageLocators:
    ...
    trainer_info_block = (By.CSS_SELECTOR, ".single_page_body_content_inner > .single_page_body_content_inner_top")
    pokeballs_number = (By.XPATH, "//span[text()='Покеболы']/following-sibling::span[1]")
    pokeballs_list = (By.XPATH, "//span[text()='Покеболы']/following-sibling::ul[1]")
    level_number = (By.XPATH, "//span[text()='Уровень']/following-sibling::span[1]")
    level_list = (By.XPATH, "//span[text()='Уровень']/following-sibling::ul[1]")
